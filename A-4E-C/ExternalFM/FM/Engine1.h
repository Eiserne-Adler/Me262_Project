...
//
//		FILE NAME	: Engine1.h
//		AUTHOR		: Black Hawk & Eiserne Adler
//		DATE		: October 2020
//
...
class Engine1 : public BaseComponent
{
public:
	Engine1(AircraftState& aircraftState);
	~Engine1();
	...
	inline void setThrottle1(double throttle);
	inline void setHasFuel( bool hasFuel );
	inline void setAirspeed( double airspeed );
	inline void setBleedAir1( bool bleedAir );
	inline void setIgnitors1( bool ignitors );
...
void Engine1::setMaxDeliverableFuelFlowFraction( double fraction )
{
	m_maxDeliverableFuelFlow = c_fuelFlowMax * fraction;
}

void Engine1::setThrottle1( double throttle )
{
	m_throttle = throttle;
}

void Engine1::setHasFuel( bool hasFuel )
{
	m_hasFuel = hasFuel;
}

void Engine1::setAirspeed( double airspeed )
{
	m_airspeed = airspeed;
}

void Engine1::setBleedAir1( bool bleedAir )
{
	m_bleedAir = bleedAir;
}

void Engine1::setIgnitors1( bool ignitors )
{
	m_ignitors = ignitors;
}

void Engine1::setTemperature( double temperature )
{
	m_temperature = temperature;
}

double Engine1::getRPMNorm()
{
	return m_hpOmega / c_maxHPOmega;
}

double Engine1::getRPM()
{
	return 60.0 * m_hpOmega / (2.0 * PI);
}

double Engine1::getThrust()
{
	return m_thrust;
}

double Engine1::getFuelFlow()
{
	return m_correctedFuelFlow;
}

double Engine1::getPID( double desiredFractionalRPM, double dt )
{
...
bool Engine1::stalled()
{
	return m_compressorStalled;
}

double Engine1::hpOmegaToLPOmega( double x )
{
...
void Engine1::updateShaftsDynamic( double dt )
{
...
void Engine1::updateShafts( double hpTarget, double inertiaFactor, double dt )
{
...
void Engine1::setCompressorDamage( double damage )
{
	m_compressorDamage = damage;
}

void Engine1::setTurbineDamage( double damage )
{
	m_turbineDamage = damage;
}

void Engine1::setIntegrity( double integrity )
{
