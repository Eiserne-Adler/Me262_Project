//=========================================================================//
//
//		FILE NAME	: Engine1.cpp
//		AUTHOR		: Eiserne Adler &  Black Hawk
//		DATE		: October 2023
//
...
Scooter::Engine1::Engine1(AircraftState& aircraftState) :
...
Scooter::Engine1::~Engine1()
{

}

void Scooter::Engine1::zeroInit()
{
	m_lpOmega = 0.0;
	m_hpOmega = 0.0;
	m_throttle = 0.0;
...
void Scooter::Engine1::coldInit()
{
	zeroInit();
}

void Scooter::Engine1::hotInit()
{
	zeroInit();
...
void Scooter::Engine1::airborneInit()
{
	zeroInit();
...
bool Scooter::Engine1::handleInput( int command, float value )
{
	switch ( command )
	{
...
void Scooter::Engine1::updateEngine( double dt )
{
